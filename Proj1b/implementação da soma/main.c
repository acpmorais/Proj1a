...
//obs.: o limite é 11 porque a condição para o JPC é s[t]=1, então para que o loop funcione corretamente o limite tem que ser 11 para que sejam realizadas as 10 iterações.
